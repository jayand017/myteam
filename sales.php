        ...
        <div class="row justify-content-center">
            ...
            <div class="col col-md-5">
                ...
                <div class="md-form">
                    ...
                    <textarea rows="5" cols="50" class="form-control" style="text-indent:4px; height:100px;"
                              name="cust_address" id="defaultForm-address"></textarea>
            ...
            <div class="col col-md-5">
                ...
                <div class="md-form">
                    ...
                    <input type="number" id="defaultForm-phone" name="card_exp_mm" class="form-control" min="01"
                           max="12" style="display:inline-block; width:170px;" placeholder="MM">
                    <input type="number" name="card_exp_yy" class="form-control" min="17" max="32"
                           style="display:inline-block; width:170px" placeholder="YY">
                </div>
                ...
                <div class="md-form">
                    ...
                    <select class="form-control" name="soft_plan" id="defaultForm-softplan"
                            style="color:#757575; font-weight:300; width:190px; margin-left:50px; display:inline-block;">
                    ...
                    <select class="form-control" name="tech_plan"
                            style="width:200px; color:#757575; font-weight:300; display:inline-block;">
                ...
                <div class="md-form">
                    ...
                    <textarea rows="5" cols="50" class="form-control" style="text-indent:4px; height:100px;"
                              name="remark" id="defaultForm-remark"></textarea>
